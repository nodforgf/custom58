...
แต่พอได้เห็นหน้าก็รู้สึกว่า อยากคุยด้วยแต่ไม่ได้หวังได้ไปมากกว่าเพื่อนคุยกัน แต่ก็ไม่คิดไม่ฝันเหมือนกันว่าเราจะมากันถึงจุดนี้ได้แบบไวมาก รู้ไหมเค้าชอบเธอตั้งแต่ที่เธอรอเค้าตอบแชท เค้าแค่รู้สึกว่าเธอนี่แหละ ที่เค้าล็อคมง
